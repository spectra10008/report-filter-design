...
<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
    <h4>Issue History (Without Notes )</h4>
    <p>This report is a mirror of the Issue History (With Notes) with the exception is does NOT include notes. This
        report is intended for individuals looking for a issue history report with NO notes included. This report has
        the following individual search options:
    </p>
    <ul>
    ...
    <p> Available in CSV (Excel) ONLY WARNING: Depending on the timeline chosen, this report will be limited to a
        maximum amount of issues per report. If you encounter a report that does not include ALL of your data search
        perameters, you will have to run another report and shorten the date parameters.
    </p>
    <p style="color:red">Maximum Issues for this Report is 100,000</p>
